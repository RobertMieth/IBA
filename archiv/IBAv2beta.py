...
class IbaTK(tk.Frame):
	...
	#Builds main Programmm Window
		...
		self.dbIndicatorF = tk.Frame(self, border = 1, relief = 'sunken', width = 15, height = 15, bg='red')
		...
		self.googleIndicatorF = tk.Frame(self, border = 1, relief = 'sunken', width = 15, height = 15, bg='yellow')
		...
		self.excelIndicatorF = tk.Frame(self, border = 1, relief = 'sunken', width = 15, height = 15, bg='green')
...
def main():
	...
	#Build Gui Root
	tkRoot = tk.Tk()
	tkRoot.geometry("440x610+300+300")
