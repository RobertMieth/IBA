...
class GoogleGrabber():
	...
	def __init__(self):
		self.cred_path = "iba_google_credential"
		...
		self.sysJson = open("sysdata.json")
...
class ExcelHandler():
	def __init__(self):
		self.sysJson = open("sysdata.json", 'r')
		self.sysData = json.load(self.sysJson)
...
class IbaTK(tk.Frame):
	...
	#Builds main Programmm Window
		...
		logo = Image.open("solandeo_logo.png")
